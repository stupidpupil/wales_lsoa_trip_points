This repository geographical trip-points for each 2011 Lower Layer Super Output Area (LSOA11) in Wales and bordering areas in England for transport-related analysis.

You can find [the code used to generate these trip-points here](https://github.com/stupidpupil/wales_lsoa_trip_points/tree/main).

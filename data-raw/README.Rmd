...
1. For roughly the third of Welsh LSOAs with the greatest areas, I find the town, village, bus stop, train station or pub nearest to the population-weighted centroid (with a slight preference towards places earlier in that list).
